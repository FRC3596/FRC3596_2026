...
public class RobotContainer {
  ...
  // Constants.Manipulator.autoAgitatorSpeed);
...
private final AgitatorCom m_runAgitator = new AgitatorCom(m_StorageSub, Constants.Manipulator.agitatorSpeed);
  ...
  // private final RollerCom m_RollerInCom = new RollerCom(m_intakeSub,
  // Constants.Manipulator.autoIntakeSpeed);
  // private final RollerCom m_RollerOutCom = new RollerCom(m_intakeSub,
  // -Constants.Manipulator.autoIntakeSpeed);
