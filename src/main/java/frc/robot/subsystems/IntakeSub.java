...
public class IntakeSub extends SubsystemBase {
  ...
  // if (((intakeSpeed > 0) && p1encoder.getPosition() >=
  // Constants.Manipulator.maxIntakePose)) {
  // Intake1.set(0);

  // }
  // else if (((intakeSpeed < 0) && p1encoder.getPosition() <=
  // Constants.Manipulator.minIntakePose)){
  // Intake1.set(0);
  // Roller1.set(0);
  // }
  // else{
...
// private final SparkMax Roller1 = new SparkMax(Constants.CANBus.Intake1,
// MotorType.kBrushless);
// private final SparkMax pivotIntake1 = new
// SparkMax(Constants.CANBus.pivotIntake1, MotorType.kBrushless);
// private final SparkMax pivotIntake2 = new
// SparkMax(Constants.CANBus.pivotIntake2, MotorType.kBrushless);
// private SparkMaxConfig p2Config = new SparkMaxConfig();
// private SparkMaxConfig p1Config = new SparkMaxConfig();
// // private ClosedLoopConfig PIDConfig = new ClosedLoopConfig();
// private final RelativeEncoder p1encoder = pivotIntake1.getEncoder();
// // private final SparkClosedLoopController pivotPID =
// pivotIntake1.getClosedLoopController();
...
// PIDConfig.feedForward.kCosRatio(0);
// kCosValue = SmartDashboard.getNumber("kCos Value", 0);
// PIDConfig.pid(Constants.Manipulator.pivotProportion,
// Constants.Manipulator.pivotIntegral,
// Constants.Manipulator.pivotDerivative).outputRange(-1, 1);
// p1Config.apply(PIDConfig);
// p1Config.smartCurrentLimit(Constants.Manipulator.maxPivotCurrentLimit);
// pivotIntake1.configure(p1Config, ResetMode.kNoResetSafeParameters,
// PersistMode.kPersistParameters);

// p2Config.follow(pivotIntake1, true);
// p2Config.smartCurrentLimit(Constants.Manipulator.maxPivotCurrentLimit);
// // p2Config.apply(PIDConfig);
// pivotIntake2.configure(p2Config, ResetMode.kNoResetSafeParameters,
// PersistMode.kPersistParameters);
...
// public void runIntake(double speed) {
// if (Math.abs(p1encoder.getPosition()) >
// Math.abs(Constants.Manipulator.intakeDownRotations / 2)) {
// Roller1.set(speed);
// SmartDashboard.putBoolean("Rollers Active", true);
// } else {
// Roller1.set(0);
...
// * public class IntakeSub extends SubsystemBase {
// *
// * private final SparkMax Intake1 = new
// SparkMax(Constants.CANBus.pivotIntake1,
// * MotorType.kBrushless);
// * private final SparkMax Intake2 = new
// SparkMax(Constants.CANBus.pivotIntake2,
// * MotorType.kBrushless);
// * private SparkMaxConfig p2Config = new SparkMaxConfig();
// * private SparkMaxConfig p1Config = new SparkMaxConfig();
